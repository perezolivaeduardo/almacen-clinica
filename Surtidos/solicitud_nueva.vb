Public Class solicitud_nueva
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Try
            ...
            '===============================================================================================
            'Pasa al area 6 los prodctos 663 (mascarillas) que esten en area 7 o 3
            'UPDATE       hs_productos SET  area = 6  WHERE  area = 7 AND  id_producto = 3 OR Id_producto = 663
            '===============================================================================================
        ...
        '===============================================
        '    Manda a Crear Consumos
        '===============================================

        'cargar_consumos_new(Me.DateTimePicker1.Value.ToShortDateString)
        cargar_tabla(DateTimePicker1.Value.ToShortDateString)
        ...
        finalfinal.Text = Now.ToShortTimeString
        Me.Refresh()

        'si es sabado o 24 de diciembre no sube el surtido a la nube
        Dim navidad As Date = CDate("24/12/2020")
        ...
        cobalsky("Se generaron Surtidos " + Now.ToShortTimeString, "Surtidos")
    ...
    Private Sub cargar_tabla(ByVal fecha As Date)
        ' aun que la tabla se llama cuentas cerradas no son las cuentas cerradas
        status.Text = "Calculando consumos ..."
        inicial.Text = Now.ToShortTimeString
        StatusStrip1.Refresh()
        Dim tbl As New DataTable, sql As String
        Dim f1, f2 As String
        f1 = "#" + Format(fecha, "MM/dd/yyyy") + " 0:0:1#"
        ...
        final.Text = Now.ToShortTimeString
        Me.Refresh()
    End Sub
